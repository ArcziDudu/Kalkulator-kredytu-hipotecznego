...
public class AmountsCalculationServiceImpl implements AmountsCalculationService {
    private final BigDecimal YEAR = BigDecimal.valueOf(12);
    ...
    //metody w zależnosci czy to stałe raty oraz czy jest to pierwsza rata czy kolejna
    ...
    private RateAmounts calculateConstantRate(InputData inputData, Rate previousRate) {
        interestPercent1 = inputData.getInterestPercent();
        residualAmount = previousRate.getMortgageResidual().getAmount();
